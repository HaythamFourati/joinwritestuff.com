...
<section id="who-we-are" class="relative py-16 lg:py-24">
  ...
  <div class="max-w-5xl mx-auto px-4">
    ...
    <div class="text-center max-w-2xl mx-auto">
      ...
      <a href="<?php echo !empty(STRIPE_WAITLIST_LINK) ? esc_url(STRIPE_WAITLIST_LINK) : '#contact'; ?>" class="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-primary text-white text-base font-semibold hover:bg-primary/90 transition-colors duration-200">
